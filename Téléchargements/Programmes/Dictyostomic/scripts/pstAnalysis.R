...
references = read.table("output_files/pstGenes/pstGenesInfo.txt", skip = 1, header = T, sep = "\t");
...
pdf("output_files/pstGenes/expressionClusters.pdf", height = n + 15 * (1/log10(n)), width = 30)
