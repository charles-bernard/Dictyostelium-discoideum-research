...
input = "output_files/cell_cell_adhesion/cell_cell_adhesion_info.txt"
output = "toto.pdf"
...
#indx <- sapply(parikh_phenotype, is.factor)
#parikh_phenotypeMat = parikh_phenotype
#parikh_phenotypeMat[indx] <- lapply(parikh_phenotypeMat[indx], function(x) as.numeric(as.character(x)))
